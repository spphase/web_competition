...
// 		$(".video_ls").removeClass("on");
// 		$(".controls").css({width:"764px"});
// 		$("#qp").attr("class","glyphicon glyphicon-resize-full");
// 	}else{
// 		$(".video_ls").addClass("on");
// 		var oBox=$("body").width()-66;
// 		$(".controls").css({width:oBox+'px'}).css("z-index","99")
// 		$("#qp").attr("class","glyphicon glyphicon-resize-small")
// 	}
// })
/*收藏*/
$("#like").click(function(){
...
vBtn.onmousedown = function(ev){
    ...
    document.onmousemove = function(ev){
        ...
        //静音改变音量图标
        // if(!vids.volume){
        // 	document.getElementByClass("glyphicon").classList.remove("glyphicon-volume-up");
        //     document.getElementByClass("glyphicon").classList.add("glyphicon-volume-of");
        // }else{
        //     document.getElementByClass("glyphicon").classList.remove("glyphicon-volume-of");
        //     document.getElementByClass("glyphicon").classList.add("glyphicon-volume-up");
        // }
    }
